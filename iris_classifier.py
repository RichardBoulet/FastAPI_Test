...
# Simple iris classifer model to test fastapi and heroku deploy. 
# Model from https://towardsdatascience.com/deploying-iris-classifications-with-fastapi-and-docker-7c9b83fdec3a
